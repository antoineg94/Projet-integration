    ...
    <form method="POST" class="mb-4 col-xl-7 col-11 mx-auto" action="{{ route('formulairesTravails.enregistrer') }}">
        ...
        <div class="form-outline mb-4">
            ...
            <div class="form-check">
                ...
                <label class="form-check-label" for="description_blessure">Entorse, élongation, foulure, luxation, contusion</label>
            </div>

            
            <div class="form-check">
                <input class="form-check-input" type="checkbox" value="Fracture, amputation" id="7" name="description_blessure">
                <label class="form-check-label" for="description_blessure">Fracture, amputation</label>
            </div>

            
            <div class="form-check">
                <input class="form-check-input" type="checkbox" value="Irritation, infection" id="8" name="description_blessure">
                <label class="form-check-label" for="description_blessure">Irritation, infection</label>
            </div>

            
            <div class="form-check">
                <input class="form-check-input" type="checkbox" value="Inhalation" id="9" name="description_blessure"> 
                <label class="form-check-label" for="description_blessure">Inhalation</label>
            </div>

            <div class="form-check">
                <input class="form-check-input" type="checkbox" value="Autre" id="10" name="description_blessure"> 
                <label class="form-check-label" for="description_blessure">Autre</label>
            </div>
