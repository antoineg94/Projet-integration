...
@if (isset($zoomForm3s))
  ...
  @if (Session::get('admin') == true || Session::get('superviseur') == true && Session::get('employe_id') != $zoomForm3s->employe_id && $zoomForm3s->statut != 'Valide')  
    <div class="container">
        ...
        <h3>Validation du formulaire:</h3>
          @CSRF
            <p>
              ...
              je ({{ $zoomForm3s->superviseur }}) confirme que cette demande est valide en date du {{ now() }}.
            </p>
